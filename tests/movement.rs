...
fn test_shift_north_from_d4() {
    ...
    let result = shift(d4_bb.bitboard, RayDirections::North);
...
fn test_shift_east_from_h4_should_be_zero() {
    ...
    let result = shift(h4_bb.bitboard, RayDirections::East);
    assert_eq!(result, 0);
}
...
fn test_shift_southeast_from_a1_should_be_zero() {
    ...
    let result = shift(a1_bb.bitboard, RayDirections::SouthEast);
    assert_eq!(result, 0);
}
...
fn test_shift_northeast_from_d4() {
    let d4_bb = bitboard_with_square(Square::D4);
    let result = shift(d4_bb.bitboard, RayDirections::NorthEast);
...
fn test_knight_shift_north_northeast_from_d4() {
    let d4_bb = bitboard_with_square(Square::D4);
    let result = knight_shift(d4_bb.bitboard, KnightDirections::NorthNorthEast);
...
fn test_knight_shift_north_north_east_from_h6_should_be_zero() {
    ...
    let result = knight_shift(h4_bb.bitboard, KnightDirections::NorthNorthEast);
    assert_eq!(result, 0);
}
...
fn test_knight_shift_southsoutheast_from_a1_should_be_zero() {
    let a1_bb = bitboard_with_square(Square::A1);
    let result = knight_shift(a1_bb.bitboard, KnightDirections::SouthSouthEast);
    assert_eq!(result, 0);
}
